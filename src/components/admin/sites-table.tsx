  ...
  return (
    <div style={container}>
      ...
      <ul className="md:hidden divide-y" style={{ borderColor: "var(--app-border)" }}>
        {sites.map((site) => (
          <li key={site.id} style={{ padding: "0.875rem 1rem" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: "0.5rem", marginBottom: "0.25rem" }}>
              <span style={{ fontWeight: 600, color: "var(--app-body-text)", fontSize: "0.9375rem" }}>{site.name}</span>
              <span style={{ fontSize: "0.75rem", fontWeight: 600, padding: "0.2rem 0.6rem", borderRadius: "9999px", flexShrink: 0,
            ...
            <p style={{ fontSize: "0.8125rem", color: "var(--app-text-muted)", display: "flex", alignItems: "center", gap: "0.25rem", marginBottom: "0.125rem" }}>
              <Globe style={{ width: "0.75rem", height: "0.75rem" }} />{site.domain}
            </p>
            <p style={{ fontSize: "0.8125rem", color: "var(--app-text-muted)", display: "flex", alignItems: "center", gap: "0.25rem", marginBottom: "0.5rem" }}>
              <Building2 style={{ width: "0.75rem", height: "0.75rem" }} />{site.company.name}
            </p>
              ...
              <tr key={site.id} style={{ borderBottom: "1px solid var(--app-border)" }}>
                ...
                <td style={{ padding: "0.75rem 1rem" }}>
                  <span style={{ display: "inline-flex", alignItems: "center", gap: "0.375rem", color: "var(--app-text-muted)" }}>
                    <Globe style={{ width: "0.875rem", height: "0.875rem" }} />{site.domain}
                  </span>
                </td>
                <td style={{ padding: "0.75rem 1rem" }}>
                  <span style={{ display: "inline-flex", alignItems: "center", gap: "0.375rem", color: "var(--app-text-muted)" }}>
                    <Building2 style={{ width: "0.875rem", height: "0.875rem" }} />{site.company.name}
                  </span>
                </td>
                <td style={{ padding: "0.75rem 1rem" }}>
                  <div style={{ display: "flex", gap: "0.375rem" }}>
                    {site.documentation && <span style={{ fontSize: "0.75rem", fontWeight: 600, padding: "0.2rem 0.5rem", borderRadius: "0.25rem", backgroundColor: "rgba(96,165,250,0.12)", color: "#60a5fa" }}>Docs</span>}
                    {site.architecture && <span style={{ fontSize: "0.75rem", fontWeight: 600, padding: "0.2rem 0.5rem", borderRadius: "0.25rem", backgroundColor: "rgba(192,132,252,0.12)", color: "#c084fc" }}>Arq.</span>}
                    {!site.documentation && !site.architecture && <span style={{ color: "var(--app-text-muted)", fontSize: "0.8125rem" }}>—</span>}
                  </div>
                </td>
                <td style={{ padding: "0.75rem 1rem" }}>
