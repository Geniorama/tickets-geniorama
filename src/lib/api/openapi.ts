...
const projectSchema = {
  ...
  properties: {
    ...
    status: {
      ...
      description: "Derivado de isDraft e isActive. Hasta v1.103 tenía cinco valores (PLANIFICACION…).",
    },
    isActive: { type: "boolean" },
    isDraft: { type: "boolean", description: "Borrador: solo lo ve su creador. La API nunca devuelve borradores ajenos." },
